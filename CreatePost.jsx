...
<p className="mt-4 text-[#666e75] text-[18px] max-w[500px]">Create imaginative and visually stunning images through DALL-E AI and share them with your community</p>
</div>
...
className="w-full text-white bg-green-700 font-medium
rounded-md sm:w-auto px-5 py-2.5
text-center"
>
